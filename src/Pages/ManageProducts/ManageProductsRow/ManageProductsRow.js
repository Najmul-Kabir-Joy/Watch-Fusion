...
const ManageProductsRow = ({ product, handleDelete }) => {
    ...
    const { _id, productName, brandName, price, discount, img, description, time } = product;
    ...
    return (
        <>
            <tr className="text-black  border-b border-indigo-600">
                ...
                <td className="border-l border-r  font-semibold border-indigo-600 uppercase">{description}</td>
