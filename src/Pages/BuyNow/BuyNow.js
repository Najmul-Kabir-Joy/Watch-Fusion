...
const BuyNow = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(
        "https://watch-fusion-server-production.up.railway.app/orders",
        data
      )
      .then((res) => {
          ...
          <div className="flex flex-col md:w-full">
            ...
            >
              <div className="">
                ...
                <div className="mt-4">
                  <button className="w-full px-6 py-2 text-white bg-indigo-600 hover:bg-indigo-900">
                    Process
                  </button>
                </div>
              </div>
              ...
              <div className="mt-8">
                <div className="flex flex-col space-y-4">
                  <div className="flex space-x-4">
                    <div>
                      <img src={img} alt="productimage" className="w-40" />
                    </div>
                    <div>
